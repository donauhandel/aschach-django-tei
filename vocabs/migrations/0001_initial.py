    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indentifier', models.URLField(blank=True, default='http://www.vocabs/donauhandel-norm/', help_text='URI')),
                ('description', models.TextField(blank=True, help_text='Description of current vocabulary')),
                ('description_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='Description language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='skos:prefLabel language')),
                ...
                ('skos_note_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='skos:note language')),
                ...
                ('skos_scopenote_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='skos:scopeNote language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('namespace', models.URLField(blank=True, default='http://www.vocabs/donauhandel-norm/')),
                ('prefix', models.CharField(blank=True, default='donauhandel-norm', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dc_title_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='dc:title language')),
                ...
                ('dc_description_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='dc:description language')),
                ('legacy_id', models.CharField(blank=True, max_length=200)),
                ('date_created', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('date_modified', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pref_label_lang', models.CharField(blank=True, default='de', help_text='Language code of preferred label according to ISO 639-3', max_length=3, verbose_name='skos:prefLabel language')),
                ...
                ('definition_lang', models.CharField(blank=True, default='de', max_length=3, verbose_name='skos:definition language')),
