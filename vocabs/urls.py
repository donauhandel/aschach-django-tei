...
urlpatterns = [
    ...
    path(
        "update/<int:pk>", views.SkosConceptUpdate.as_view(), name="skosconcept_update"
    ),
    path(
        "delete/<int:pk>", views.SkosConceptDelete.as_view(), name="skosconcept_delete"
    ),
    ...
    path(
        "metadata/<int:pk>", views.MetadataDetailView.as_view(), name="metadata_detail"
    ),
