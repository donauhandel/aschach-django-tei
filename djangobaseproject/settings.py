...
ARCHE_CONST_MAPPINGS = [
    ...
    (
        "hasCreator",
        "https://d-nb.info/gnd/1031446176",
    ),  # Serles
    (
        "hasCreator",
        "https://d-nb.info/gnd/103048337X",
    ),  # Pamperl
    (
        "hasLicense",
...
PHAIDRA_BASE = (
    "https://fedora.phaidra.univie.ac.at/fedora/objects/{}/methods/bdef:Content/get"
)
...
DATA_REPO_URL = (
    "https://raw.githubusercontent.com/donauhandel/aschach-data/main/orig_data/csvs/"
)
